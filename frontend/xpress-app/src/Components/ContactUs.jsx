...
const contactInfo = [
  {
    name: "Phone",
    description:
      "You can call us at the shop here at: (609) 348-0894. Our team is ready to assist you with any questions or to schedule your appointment.",
  ...
  },
  {
    ...
    description:
      "Mail us at this address: 2425 Atlantic Ave, Atlantic City, NJ 08401",
    image: "/images/email.png",
  },
  {
    name: "Social Media Platforms",
    description:
      "Follow us on our social media platforms for updates and promotions.",
          ...
          >
            ...
            >
              <img
                ...
                onMouseEnter={(e) =>
                  (e.target.style.transform = "translateX(-3px) rotate(-2deg)")
                }
                onMouseLeave={(e) =>
                  (e.target.style.transform = "translateX(0) rotate(0deg)")
                }
              />
            </div>
